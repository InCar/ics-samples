  ...
  <div class="hy-error">
    <div class="hy-error-main">
      <div class="hy-error-bg">
        <img class="hy-error-img"
             src="../../images/404/404.png"
             alt="404" />
        <div class="hy-error-shadow">
          <img class="animate_shadow"
               src="../../images/404/404-shadow.png"
               alt="shadow" />
        </div>
        <div class="hy-error-animate">
          <img class="animate_1"
               src="../../images/404/404-1.png"
               alt="1" />
          <img class="animate_2"
               src="../../images/404/404-2.png"
               alt="2" />
          <img class="animate_3"
               src="../../images/404/404-3.png"
               alt="3" />
          <img class="animate_4"
               src="../../images/404/404-4.png"
               alt="4" />
          <img class="animate_5"
               src="../../images/404/404-5.png"
               alt="5" />
        </div>
      </div>
      <p>你迷路了...别着急，点
        <a href="JavaScript:history.go(-2)">这里</a>找到出路</p>
    </div>
  </div>
</template>
<script>
