...
public class IcsMapController extends JacksonJsonReader {
    ...
    public IcsMapController() {
        ...
        //包名配置
//        config.addScanPackages("com.abc");

        //数据库自定义配置
/*        JdbcConfig mysqlConfig = new JdbcConfig("com.mysql.cj.jdbc.Driver", "jdbc:mysql://127.0.0.1:3306/test?characterEncoding=utf8&useSSL=false&rewriteBatchedStatements=true&serverTimezone=UTC&autoReconnect=true", "root", "maptracking");
